...
export const PriceAlertModal: React.FC<PriceAlertModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-[clamp(0.75rem,2vw,1.25rem)] bg-slate-950/60 backdrop-blur-xs animate-in fade-in duration-200">
      <div className="relative w-full max-w-[min(100%,28rem)] bg-white rounded-2xl shadow-2xl border border-slate-200 p-[clamp(1.1rem,2.5vw,1.5rem)] overflow-hidden">
        {/* Close Button */}
        <button
          onClick={handleClose}
