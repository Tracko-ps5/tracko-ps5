...
export const SEO_ROUTES: Record<string, SeoConfig> = {
  '/': {
    title: 'TRACKO - Tracker & Comparateur de Prix PS5 en Direct',
    description: 'TRACKO compare en temps réel les prix de la PlayStation 5 (Standard, Slim, Pro). Alertes stocks, historique des prix et comparatif des marchands.',
  ...
  '/ps5-slim': {
    ...
    ogTitle: 'PS5 Slim - Suivi des Prix et Stocks en Temps Réel | TRACKO',
